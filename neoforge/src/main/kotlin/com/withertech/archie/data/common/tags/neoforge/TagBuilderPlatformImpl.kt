package com.withertech.archie.data.common.tags.neoforge
...
object TagBuilderPlatformImpl
{
	...
	class ArchieTagBuilder<T : Any>(private val parent: TagsProvider.TagAppender<T>, private val provider: ArchieTagsProvider<T>) :
		TagsProvider.TagAppender<T>(parent.builder, provider.mod.modId), IArchieTagBuilder<T>
	{
