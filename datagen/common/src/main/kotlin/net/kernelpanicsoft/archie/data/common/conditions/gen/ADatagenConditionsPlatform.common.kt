...
/**
 * Datagen-only half of [net.kernelpanicsoft.archie.data.common.conditions.AConditionsPlatform] -
 * attaching conditions to a *generated* recipe. Split out from that class itself since neither
 * member has any runtime presence.
 */
