...
import net.kernelpanicsoft.archie.data.common.conditions.AAndCondition
import net.kernelpanicsoft.archie.data.common.conditions.AEqualsCondition
import net.kernelpanicsoft.archie.data.common.conditions.AFalseCondition
import net.kernelpanicsoft.archie.data.common.conditions.AModLoadedCondition
import net.kernelpanicsoft.archie.data.common.conditions.ANotCondition
import net.kernelpanicsoft.archie.data.common.conditions.AOrCondition
import net.kernelpanicsoft.archie.data.common.conditions.APlatformCondition
import net.kernelpanicsoft.archie.data.common.conditions.ARegistryCondition
import net.kernelpanicsoft.archie.data.common.conditions.ATrueCondition
import net.kernelpanicsoft.archie.data.common.conditions.AXorCondition
