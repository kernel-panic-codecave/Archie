	...
	IADataProvider
{
	...
	/** On Fabric, a wrapping [RecipeProvider] needed for [ADatagenConditionsPlatform.withCondition] support; `null` elsewhere. */
	private val fabricParent: RecipeProvider? = ADatagenConditionsPlatform.fabricRecipeProvider(this, registries)
