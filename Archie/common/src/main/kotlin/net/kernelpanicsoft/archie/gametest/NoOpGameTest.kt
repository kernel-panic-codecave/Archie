 ...
 * when a mod's [AGameTestModFilter]-selected suite has no real test functions for the current
 * [AGameTestSide] - e.g. a mod with only client-side coverage (like Archie-Test, whose own suite
