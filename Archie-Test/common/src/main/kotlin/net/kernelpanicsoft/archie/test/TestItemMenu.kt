...
/** Fixture item-backed menu for [net.kernelpanicsoft.archie.test.gametest.ComposeItemContainerMenuTests]/[net.kernelpanicsoft.archie.test.gametest.ItemStateManagerTests]. */
