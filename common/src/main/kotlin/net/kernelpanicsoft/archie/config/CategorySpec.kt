...
abstract class CategorySpec(internal val title: Component, internal val id: String = title.string.toSnakeCase())
{
	...
	protected fun <T : CategorySpec> spec(
		...
		PropertyDelegateProvider { _, property ->
			...
			types[id] = FieldType.Spec { default } as net.kernelpanicsoft.archie.config.FieldType<T>
	...
	protected fun <T : CategorySpec> specList(
		...
		PropertyDelegateProvider { _, property ->
			...
			types[id] = FieldType.SpecList(factory) as net.kernelpanicsoft.archie.config.FieldType<List<T>>
	...
	protected fun <T : CategorySpec> specMap(
		...
		PropertyDelegateProvider { _, property ->
			...
			types[id] = FieldType.SpecMap(factory) as net.kernelpanicsoft.archie.config.FieldType<Map<String, T>>
