...
class MultiPartBlockStateBuilder(private val owner: Block) : IGeneratedBlockState
{
	private val parts: MutableList<PartBuilder> = ArrayList()

	private var config: (PartBuilder.() -> Unit)? = null
	fun part(): ConfiguredModel.Builder<PartBuilder>
	{
		return ConfiguredModel.builder(this)
	}

	fun part(block: ConfiguredModel.Builder<PartBuilder>.() -> Unit): PartBuilder
	{
		return ConfiguredModel.builder(this)
			.apply(block)
			.addModel()
	...
	fun addPart(part: PartBuilder): MultiPartBlockStateBuilder
	{
		parts.add(part)
		return this
	}
	...
	inner class PartBuilder internal constructor(models: ArchieBlockStateProvider.ConfiguredModelList)
	{
		var models: ArchieBlockStateProvider.ConfiguredModelList = models
		...
		fun end(): MultiPartBlockStateBuilder
		{
			return this@MultiPartBlockStateBuilder
		}
