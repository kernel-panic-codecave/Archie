...
abstract class CustomLoaderBuilder<T : ModelBuilder<T>> protected constructor(
...
)
{
	 ...
	 * @param parent             The parent [ModelBuilder]
	 */
	...
	fun visibility(partName: String, show: Boolean): CustomLoaderBuilder<T>
	{
	 ...
	 */
	fun optional(): CustomLoaderBuilder<T>
	{
