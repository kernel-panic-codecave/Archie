...
abstract class ArchieTagsProvider<T : Any>(
...
) : TagsProvider<T>(output, registryKey, registries), IArchieDataProvider
{
	...
	{
		return TagBuilderPlatform.createTagBuilder(super.tag(this), this@ArchieTagsProvider)
	}
	...
	abstract class BlockTagsProvider(
		...
		ArchieTagsProvider<Block>(output, mod, Registries.BLOCK, registriesFuture, exitOnError)
	{
	...
	abstract class FluidTagsProvider(
		...
		ArchieTagsProvider<Fluid>(output, mod, Registries.FLUID, registriesFuture, exitOnError)
	{
	...
	abstract class EntityTypeTagsProvider(
		...
		ArchieTagsProvider<EntityType<*>>(output, mod, Registries.ENTITY_TYPE, registriesFuture, exitOnError)
	{
	...
	abstract class BiomeTagsProvider(
		...
		ArchieTagsProvider<Biome>(output, mod, Registries.BIOME, registriesFuture, exitOnError)
	{
