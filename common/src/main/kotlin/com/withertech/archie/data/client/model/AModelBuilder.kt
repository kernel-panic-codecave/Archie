...
{
	protected var parent: AModelFile? = null
	...
	protected var customLoader: ACustomLoaderBuilder<T>? = null
	...
	fun texture(key: String, texture: String): T
	{
		...
		} else
		{
			...
			{
				ResourceLocation.fromNamespaceAndPath(location.namespace, texture)
			}
