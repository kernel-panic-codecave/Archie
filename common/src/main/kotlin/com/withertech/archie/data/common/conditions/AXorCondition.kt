	...
	AGroupCondition()
{
	...
	companion object
	{
		val CODEC: MapCodec<AXorCondition> =
			RecordCodecBuilder.mapCodec { builder: RecordCodecBuilder.Instance<AXorCondition> ->
				builder.group(
					IACondition.CODEC.listOf().fieldOf("children").forGetter(AXorCondition::children),
				).apply(builder, ::AXorCondition)
			}
		val ID: ResourceLocation = ResourceLocation.fromNamespaceAndPath(Archie.MOD_ID, "xor")
	}
}